// СПРИНТ 2. ИТОГОВЫЙ ПРОЕКТ. ФРЕЙМВОРК И ПОИСКОВАЯ СИСТЕМА.
//---------------------------------------------------------
// ПРАВКИ:
// - добавил глобальную константу MEASURE
// - изменил название теста
// - убрал лишне пробелы в MatchDocument
// - не понимаю что происходит с отступами. В среде (VS) вроде все ровненько отображается..
//---------------------------------------------------------
