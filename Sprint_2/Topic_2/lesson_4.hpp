...
//=========================================================================
// Шаблонные операторы вывода в поток

template <typename T>
ostream& operator<<(ostream& output, const std::vector<T>& container)
{
    bool is_first = true;
...
template <typename T>
ostream& operator<<(ostream& output, const std::set<T>& container)
{
    bool is_first = true;
...
ostream& operator<<(ostream& output, const std::map<Key, Value>& container)
{
    bool is_first = true;
