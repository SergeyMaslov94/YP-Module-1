...
//#include "Topic_3/lesson_1_1.hpp"
...
int main()
{
    ...
    /*
    *---------------------------------------------------------------------------------------------------------------
    ТРИ ВОППРОСА РЕКУРСИИ!
    1. Какие параметры принимает функция?
    2. В каком случае мы можем остановить алгоритм?
    3. Что делать, если алгоритм не остановился?
    *---------------------------------------------------------------------------------------------------------------
    */
	...
	*/
    ...
    //===============================================
	/* Топик_3: Стек и очередь FIFO и LIFO*/
    //top_3_lesson_1_1();  // Пишем стек
    //top_3_lesson_1_2();  // Стек с доступом к минимальному элементу
